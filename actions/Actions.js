export default class Actions {
    ...
    static fire(store_id, type = '', payload = {}, dispatcher) {
        if (type === 'ADD_TIMER') {
            ...
            Actions.subscribers[store_id].Update('start-timer', payload, dispatcher);
        } else if (type === 'PAUSE_TIMER') {
            Actions.subscribers[store_id].Update('pause-timer', payload, dispatcher);
